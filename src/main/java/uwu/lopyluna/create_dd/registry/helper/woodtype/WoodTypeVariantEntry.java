...
public class WoodTypeVariantEntry {
    ...
    public WoodTypeVariantEntry(String name, DesiresWoodType paletteStoneVariants) {
        ...
        for (WoodTypeBlockPattern pattern : paletteStoneVariants.variantTypes) {
            ...
            for (WoodTypePartial<? extends Block> partialBlock : pattern.getPartials())
