...
public class BlockZapperScreen extends ZapperScreen {
	...
	public void removed() {
		...
		DesiresPackets.getChannel().sendToServer(packet);
	}
	...
	protected void drawOnBackground(PoseStack matrixStack, int x, int y) {
		...
		for (int index = 2; index >= currentBrush.amtParams; index--)
			DesiresGuiTextures.BLOCK_ZAPPER_INACTIVE_PARAM.render(matrixStack, x + 56 + 20 * index, y + 40, this);
