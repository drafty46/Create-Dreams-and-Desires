...
public interface Builder<R, T extends R, P, S extends Builder<R, T, P, S>> extends NonNullSupplier<RegistryEntry<T>> {
    ...
    default RegistryEntry<T> get() {
        return new RegistryEntry<>(getOwner().<R, T> get(getName(), getRegistryKey()));
    }
    ...
    default <D extends RegistrateProvider> S setData(ProviderType<? extends D> type, NonNullBiConsumer<DataGenContext<R, T>, D> cons) {
        getOwner().setDataGenerator((com.tterrag.registrate.builders.Builder<R, T, P, ?>) (Object) this, type, prov -> cons.accept(DataGenContext.from(this, getRegistryKey()), (D) prov));
        return (S) this;
    }
     ...
     * @return this {@link com.tterrag.registrate.builders.Builder}
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Apply a transformation to this {@link com.tterrag.registrate.builders.Builder}. Useful to apply helper methods within a fluent chain, e.g.
     *
     * <pre>
     * {@code
     ...
     * @return the {@link com.tterrag.registrate.builders.Builder} returned by the given function
     */
    @SuppressWarnings("unchecked")
    default <R2, T2 extends R2, P2, S2 extends com.tterrag.registrate.builders.Builder<R2, T2, P2, S2>> S2 transform(NonNullFunction<S, S2> func) {
