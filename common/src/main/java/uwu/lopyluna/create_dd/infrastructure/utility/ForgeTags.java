...
// From https://github.com/Fabricators-of-Create/Porting-Lib/blob/1.19.3/tags/src/main/java/me/alphamode/forgetags/Tags.java
public class ForgeTags {
	...
	public static class Items {
		...
		public static final TagKey<Item> DYES_BLACK = ((AccessDyeColor) (Object) DyeColor.BLACK).getTag();
		public static final TagKey<Item> DYES_RED = ((AccessDyeColor) (Object) DyeColor.RED).getTag();
		public static final TagKey<Item> DYES_GREEN = ((AccessDyeColor) (Object) DyeColor.GREEN).getTag();
		public static final TagKey<Item> DYES_BROWN = ((AccessDyeColor) (Object) DyeColor.BROWN).getTag();
		public static final TagKey<Item> DYES_BLUE = ((AccessDyeColor) (Object) DyeColor.BLUE).getTag();
		public static final TagKey<Item> DYES_PURPLE = ((AccessDyeColor) (Object) DyeColor.PURPLE).getTag();
		public static final TagKey<Item> DYES_CYAN = ((AccessDyeColor) (Object) DyeColor.CYAN).getTag();
		public static final TagKey<Item> DYES_LIGHT_GRAY = ((AccessDyeColor) (Object) DyeColor.LIGHT_GRAY).getTag();
		public static final TagKey<Item> DYES_GRAY = ((AccessDyeColor) (Object) DyeColor.GRAY).getTag();
		public static final TagKey<Item> DYES_PINK = ((AccessDyeColor) (Object) DyeColor.PINK).getTag();
		public static final TagKey<Item> DYES_LIME = ((AccessDyeColor) (Object) DyeColor.LIME).getTag();
		public static final TagKey<Item> DYES_YELLOW = ((AccessDyeColor) (Object) DyeColor.YELLOW).getTag();
		public static final TagKey<Item> DYES_LIGHT_BLUE = ((AccessDyeColor) (Object) DyeColor.LIGHT_BLUE).getTag();
		public static final TagKey<Item> DYES_MAGENTA = ((AccessDyeColor) (Object) DyeColor.MAGENTA).getTag();
		public static final TagKey<Item> DYES_ORANGE = ((AccessDyeColor) (Object) DyeColor.ORANGE).getTag();
		public static final TagKey<Item> DYES_WHITE = ((AccessDyeColor) (Object) DyeColor.WHITE).getTag();
