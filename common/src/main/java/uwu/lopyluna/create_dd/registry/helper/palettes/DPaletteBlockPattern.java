...
public class DPaletteBlockPattern {
	...
	public static final DPaletteBlockPattern[] VANILLA_RANGE = { CUT, POLISHED, BRICKS, SMALL_BRICKS, LAYERED, PILLAR };

	public static final DPaletteBlockPattern[] STANDARD_RANGE = { CUT, POLISHED, BRICKS, SMALL_BRICKS, LAYERED, PILLAR };
	...
	private DPaletteBlockPartial<? extends Block>[] partials;

	@Environment(EnvType.CLIENT)
	private RenderType renderType;

	private static DPaletteBlockPattern create(String name, PatternNameType nameType,
											   DPaletteBlockPartial<?>... partials) {
		DPaletteBlockPattern pattern = new DPaletteBlockPattern();
		pattern.id = name;
	...
	public DPaletteBlockPartial<? extends Block>[] getPartials() {
		return partials;
	}
	...
	private DPaletteBlockPattern blockStateFactory(IPatternBlockStateGenerator factory) {
		blockStateGenerator = factory;
		return this;
	}

	private DPaletteBlockPattern textures(String... textures) {
		this.textures = textures;
		return this;
	}

	private DPaletteBlockPattern block(NonNullFunction<Properties, ? extends Block> blockFactory) {
		this.blockFactory = blockFactory;
		return this;
	}

	private DPaletteBlockPattern connectedTextures(Function<String, ConnectedTextureBehaviour> factory) {
	...
	static interface IPatternBlockStateGenerator
		extends Function<DPaletteBlockPattern, Function<String, IBlockStateProvider>> {
	}
